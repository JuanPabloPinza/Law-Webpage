            ...
            {[
              ...
              <div key={index} className={`bg-slate-50 border-l-4 border-slate-700 p-6 hover:shadow-lg transition-shadow duration-300 relative overflow-hidden`}>
                <div className="absolute right-0 top-0 opacity-10 pointer-events-none">
                  {index === 0 && (
                    // Ícono de Derecho Civil: Documento/Contrato con pluma
                  ...
                  {index === 1 && (
                    // Ícono de Derecho Penal: Martillo de juez con balanza
                    <svg className="w-32 h-32 text-slate-700" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {index === 2 && (
                    // Ícono de Derecho Constitucional: Edificio gubernamental/columnas
                    <svg className="w-32 h-32 text-slate-700" viewBox="0 0 24 24" fill="currentColor">
              ...
              {[
                {
                  ...
                  image: 'https://www.thedigitalfix.com/wp-content/sites/thedigitalfix/2023/03/saul-goodman-memes-saul-goodman-3d.jpeg',
                  description: 'Más de 20 años de experiencia en litigios civiles y asesoría corporativa. Especialista en derecho comercial y contratos complejos.'
                },
                {
                  name: 'Dr. Alarcón',
                  role: 'Socio',
                  specialty: 'Derecho Laboral y Administrativo',
                  image: 'https://us-tuna-sounds-images.voicemod.net/6ff3676e-2358-4490-839c-d0906154e41d-1667875096945.jpg',
                  description: 'Experta en derecho laboral con amplia trayectoria en procedimientos administrativos y negociaciones colectivas.'
                },
                {
                  name: 'Dra. Saquicela ',
                  role: 'Socia',
                  specialty: 'Derecho Penal y Procesal',
                  image: 'https://tse4.mm.bing.net/th/id/OIP.AtPF8z4log5XFu-2G2vo0gHaHa?cb=12&rs=1&pid=ImgDetMain&o=7&rm=3',
                  description: 'Reconocido litigante en derecho penal. Defensa estratégica en casos complejos con resultados destacados.'
                }
              ].map((lawyer, index) => (
                <div key={index} className="group relative bg-slate-800 overflow-hidden shadow-xl h-96 rounded-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
